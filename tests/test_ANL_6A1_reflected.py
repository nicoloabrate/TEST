...
fig, ax = plt.subplots()
myslabD.displaygeom()
kD.solution.plot(1, normalise='peaktotalflux')
kD.solution.plot(2, normalise='peaktotalflux')
plt.title('Diffusion')
...
# fig, ax = plt.subplots()
# myslabP.displaygeom()
# kP1.solution.plot(1, normalise='peaktotalflux')
# kP1.solution.plot(2, normalise='peaktotalflux')
# plt.title('P1')
