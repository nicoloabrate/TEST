...
myslabSFV = Slab(M, xlayers, [mat], [bc], G, N+1, 'FV')
myslabSFD = Slab(M, xlayers, [mat], [bc], G, N+1, 'FD')
...
# sD.solve(algo='eig')
sP.solve(normalisation='peaktotalflux', algo='eig')
sS_FV.solve(normalisation='peaktotalflux', algo='eig')
sS_FD.solve(normalisation='peaktotalflux', algo='eig')
